...
router.get('/me', (req, res) => {
  ...
  const mockUsers = {
    RUMAH_TANGGA: { id: 1, name: 'Sari Dewi',      email: 'sari@email.com',          role: 'RUMAH_TANGGA', status: 'active', points: 1250 },
    DRIVER:       { id: 2, name: 'Budi Santoso',   email: 'budi.driver@email.com',   role: 'DRIVER',       status: 'active', points: 0 },
    ADMIN_TPS3R:  { id: 3, name: 'Admin TPS3R',    email: 'admin.tps3r@email.com',   role: 'ADMIN_TPS3R',  status: 'active', points: 0 },
    MITRA_B2B:    { id: 4, name: 'Mitra Industri', email: 'mitra@industri.com',      role: 'MITRA_B2B',    status: 'active', points: 0 },
    PEMDA:        { id: 5, name: 'Dinas Surabaya', email: 'dinas@balikpapan.go.id',  role: 'PEMDA',        status: 'active', points: 0 },
    SUPER_ADMIN:  { id: 6, name: 'Super Admin',    email: 'superadmin@etrashhub.id', role: 'SUPER_ADMIN',  status: 'active', points: 0 },
  };
