...
export default function Home() {
  ...
  useEffect(() => {
    ...
    fetchPickups();
    const interval = setInterval(fetchPickups, 15000);
  ...
  return (
    <div className="page-content" style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', paddingBottom: '5rem' }}>
      {/* Hero Greeting */}
      <div>
      ...
      <div className="home-desktop-grid">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          ...
          <div>
            <h2 style={{ fontSize: '1.125rem', fontWeight: 700, marginBottom: '0.75rem' }}>Dampak Sosial Lingkungan</h2>
        ...
        {/* Right column (Leaderboard — always shown, stacks below on mobile) */}
